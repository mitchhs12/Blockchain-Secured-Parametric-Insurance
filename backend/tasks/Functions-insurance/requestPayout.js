...
task("functions-request-payout", "Initiates a request from a Functions client contract")
  ...
  .addOptionalParam("requestgas", "Gas limit for calling the checkPolicy function", 1_500_000, types.int)
  .setAction(async (taskArgs, hre) => {
    ...
    const spinner = utils.spin({
      text: `Submitting transaction for Payout contract ${contractAddr} on network ${network.name}`,
    })
