...
task("functions-set-insurance", "Initiates a request from a Functions client contract")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const spinner = utils.spin({
      text: `Submitting transaction for Insurance contract ${contractAddr} on network ${network.name}`,
    })
